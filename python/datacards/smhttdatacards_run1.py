	...
	def __init__(self, higgs_masses=["125"], cb=None):
		...
		if cb is None:
			...
			self.add_processes(
					...
					bkg_processes=["ZTT", "ZL", "ZJ", "TTJ", "VV", "WJ", "QCD"],
			...
			# efficiencies
			self.cb.cp().channel(["mt"]).process(["ZTT", "ZL", "ZJ", "TTJ", "VV"]).AddSyst(self.cb, *self.muon_efficieny_syst_args)
			...
			# lumi
			self.cb.cp().process(["ZTT", "ZL", "ZJ", "TTJ", "VV"]).AddSyst(self.cb, *self.lumi_syst_args)
			...
			# efficiencies
			self.cb.cp().channel(["et"]).process(["ZTT", "ZL", "ZJ", "TTJ", "VV"]).AddSyst(self.cb, *self.electron_efficieny_syst_args)
			...
			self.add_processes(
					...
					bkg_processes=["ZTT", "ZL", "TTJ", "VV", "WJ", "QCD"],
					sig_processes=signal_processes,
					analysis=["htt"],
					era=["13TeV"],
					mass=higgs_masses
			...
			# efficiencies
			self.cb.cp().channel(["em"]).process(["ZTT", "ZL", "ZJ", "TTJ", "VV"]).AddSyst(self.cb, *self.electron_efficieny_syst_args)
			self.cb.cp().channel(["em"]).signals().AddSyst(self.cb, *self.electron_efficieny_syst_args)
			
			self.cb.cp().channel(["em"]).process(["ZTT", "ZL", "ZJ", "TTJ", "VV"]).AddSyst(self.cb, *self.muon_efficieny_syst_args)
			self.cb.cp().channel(["em"]).signals().AddSyst(self.cb, *self.muon_efficieny_syst_args)
			
			# lumi
			self.cb.cp().process(["ZTT", "ZL", "ZJ", "VV", "WJ"]).AddSyst(self.cb, *self.lumi_syst_args)
			...
			# lumi
			self.cb.cp().process(["ZTT", "ZL", "ZJ", "TTJ", "VV", "WJ"]).AddSyst(self.cb, *self.lumi_syst_args)
			...
			# jets
			self.cb.cp().process(["ZTT", "ZL", "ZJ", "TTJ", "VV", "WJ"]).AddSyst(self.cb, *self.jec_syst_args)
